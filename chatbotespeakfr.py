...
voice_options = ["aucune", "fr+f2", "fr+m7", "en+f2", "en+m7", "nl+f4", "nl+m7", "de+f2", "de+m7"]
...
voice_label.place(x=116,y=10)
voice_dropdown.place(x=255,y=5)
speed_label.place(x=355,y=10)
speed_scale.place(x=513,y=2)
